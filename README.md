...
### What's Included
- **OptiScaler 0.9.3-pre3 (20260604)**: Prerelease OptiScaler bundle shipped locally with this plugin, with bundled FSR4 runtime variants for either the archive-native RDNA4 path or the Steam Deck / RDNA2-3 optimized INT8 override
